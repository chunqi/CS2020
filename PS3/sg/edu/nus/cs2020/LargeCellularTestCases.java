...
public class LargeCellularTestCases {
	...
	/*
	 * TestCase
	 * Stores a single testcase read from the file.
	 */
	...
	/*
	 * Reads the file "testcases.txt" which contains
	 * large testcases for the CoverageCalacultor.
	 * Each test begins with the string: NEW_CASE
	 * The second line contains a single number: the length of the highway.
	 * The third line contains the purported answer.
	 * After that, each line represents one tower (x,y) where 
	 * x is the location and y is the range.
	 */
	...
	// This big test loads 13 tests from a file and
	// runs them against your code.
	// Below, change "CoverageCalculator" to the name of the class
	// being tested.
	@Test
	public void BigTest() {
		ReadFile();
